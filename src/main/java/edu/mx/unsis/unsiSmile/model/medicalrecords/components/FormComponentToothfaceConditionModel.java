...
@Builder
@Entity
@Table(name = "form_component_toothface_conditions")
public class FormComponentToothfaceConditionModel extends AuditModel {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_form_component_toothface_condition")
    private Long id;
    ...
    @ManyToOne
    @JoinColumn(name = "fk_toothface_condition", nullable = false)
