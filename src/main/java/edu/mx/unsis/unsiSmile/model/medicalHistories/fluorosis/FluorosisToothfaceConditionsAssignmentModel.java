...
@Builder
@Entity
@Table(name = "fluorosis_toothface_conditions_assignments")
@IdClass(FluorosisToothFaceConditionAssignmentId.class)
public class FluorosisToothfaceConditionsAssignmentModel extends AuditModel {
