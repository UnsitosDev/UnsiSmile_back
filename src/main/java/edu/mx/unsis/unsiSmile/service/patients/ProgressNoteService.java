...
public class ProgressNoteService {
    ...
    public ProgressNoteResponse createProgressNote(@NonNull ProgressNoteRequest request) {
        try {
            ...
            ProfessorClinicalAreaModel professorClinicalArea = professorClinicalAreaRepository.findById(request.getProfessorClinicalAreaId())
                    .orElseThrow(() -> new AppException(
                            ResponseMessages.PROFESSOR_CLINICAL_AREA_NOT_FOUND,
    ...
    public ResponseEntity<byte[]> buildProgressNotePdfById(String id) {
        ...
        try {
            ...
            parameters.setStudent(getStudent(progressNote.getCreatedBy()));
            parameters.setProfessor(progressNote.getProfessor().getPerson().getFullName());
            parameters.setClinicalStatus(progressNote.getClinicalStatus());
