...
CREATE TABLE
    user_app (
        ...
        CONSTRAINT FK_profile_picture FOREIGN KEY (profile_picture_id) REFERENCES profile_pictures (id_profile_picture)
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE
    patients (
        ...
        medical_record_number BIGINT (20) NOT NULL,
        ...
        UNIQUE KEY uq_medical_record_number (medical_record_number),
